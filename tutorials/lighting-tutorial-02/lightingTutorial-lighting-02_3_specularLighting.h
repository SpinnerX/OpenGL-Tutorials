 ...
 * 
 * @param SpecularLighting
 * @note Similar to diffuse lighting
 * @note Phong's lighting model is diffused lighting but adding specular highlights
 * @note Specular lighting based on light direction vector and object's normal vectors
 * @note Thoush this time is based on reflective properties of the surfaces
 * @note If we think of obj's surface as mirror, specular lighting is where we see light the strongest reflected on the surface
 * @note You'll be able to see this effect in the specular lighting figure in basics/figures/SpecularLighting.png
 * 
 * @param MoreContext
 * @note Phong lighting model in vertex shader
 * @note Advantage of doing vertex shader lighting is a lot more efficient with generally a lot less vertices compared to framents
 * @note So expensive lighting computations are done much lesser.
 * @note Though resulting color value in vertex shader is resulting lighting color of that vertex specifically only and colors surrounding fragments then resulted of interpolated lighting colors
 * @note Resulting was lighting was not realistic unless large amounts of vertices used; look at the example in basics/figures/PhongGouradLightingFigure.png
 * @note Phong lighting model implemented in vertex shader is referred to as Gouraud shading.
 * @note One thing to note is due to interpolation, lighting will look somewhat off. Phong shading gives much smoother lighting.
*/
...
void SpecularLightingExample(GLFWwindow* window){
    ...
    Shader lightShader("basics/shaders/lightTutorial-02_3/light.vert", "basics/shaders/lightTutorial-02_3/light.frag");
    Shader cubeShader("basics/shaders/lightTutorial-02_3/cube.vert", "basics/shaders/lightTutorial-02_3/cube.frag");
