...
void SpecularLightingMapsExample(GLFWwindow* window){
    ...
    Shader lightShader("basics/shaders/lightingMapsTutorial-01_2/light.vert", "basics/shaders/lightingMapsTutorial-01_2/light.frag");
    Shader cubeShader("basics/shaders/lightingMapsTutorial-01_2/cube.vert", "basics/shaders/lightingMapsTutorial-01_2/cube.frag");
