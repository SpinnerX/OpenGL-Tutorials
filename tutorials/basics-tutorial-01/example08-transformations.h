...
/**
 * @example Example #8 - Transformation
 * @note In this example code we show how rotation data gets sent to our shaders
 * @note Effectively changing how the way we move our textures
*/
...
void TransformationExample(GLFWwindow* window){
    printf("Example 08 -- Transformations\n");
    ...
    */
    ...
    Shader shader("basics/shaders/example08-transformation/shader.vert", "basics/shaders/example08-transformation/shader.frag");
