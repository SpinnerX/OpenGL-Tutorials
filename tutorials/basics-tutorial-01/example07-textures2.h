...
/**
 * @example Example #6 - Textures Part 2
 * @note The result in this is mixing two textures together
 * @note Where texture 2 should be green, and texture 1 is original texture still (meaning not modified)
*/
...
void TextureExample2(GLFWwindow* window){
    printf("Example 07 -- Textures Part 2\n");
    ...
    */
    ...
    Shader shader("basics/shaders/example07-textures/shader.vert", "basics/shaders/example07-textures/shader.frag");
    ...
    unsigned char* data2 = stbi_load("basics/textures/container.jpg", &imageWidth2, &imageHeight2, &pixelChannels2, 0);
